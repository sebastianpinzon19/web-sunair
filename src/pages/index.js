          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="relative h-80 rounded-lg overflow-hidden shadow-lg group">
                <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/images/family-living-room.webp')" }} />
                <div className="absolute inset-0 bg-sun-blue/70" />
              ...
              {/* Durability */}
              <div className="relative h-80 rounded-lg overflow-hidden shadow-lg group">
                <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/images/hvac-technician-service.webp')" }} />
                <div className="absolute inset-0 bg-sun-blue/70" />
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 text-white">
                  <div className="bg-sun-blue/10 rounded-full w-16 h-16 flex items-center justify-center mb-4">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <h3 className="text-white font-bold text-lg mb-2">Durability</h3>
                  <p className="text-white/90 text-sm leading-relaxed">
              ...
              {/* Versatility */}
              <div className="relative h-80 rounded-lg overflow-hidden shadow-lg group">
                <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/images/modern-home-comfort.webp')" }} />
                <div className="absolute inset-0 bg-sun-blue/70" />
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 text-white">
                  <div className="bg-sun-blue/10 rounded-full w-16 h-16 flex items-center justify-center mb-4">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <h3 className="text-white font-bold text-lg mb-2">Versatility</h3>
                  <p className="text-white/90 text-sm leading-relaxed">
